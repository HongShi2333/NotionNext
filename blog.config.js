...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '红石Hong', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '2021级12班的普通学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://classmate.hongshi.us.kg', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 同学录', // 网站关键词 英文逗号隔开
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9182006753', // 对应歌单的 id
